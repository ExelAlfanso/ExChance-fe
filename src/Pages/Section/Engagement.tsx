...
const Engagement: React.FC<EngagementProps> = ({ id, className, children }) => {
  return (
    <div
      id={id}
      className={`flex flex-col items-center justify-center bg-primary font-semibold ${className} px-10 mb-14 lg:mb-16`}
    >
      <div className="gap-2 text-center mb-5 lg:mb-16">
